...
## v24.8 Clean 3-stage F-mean
- ใช้ฐาน v24.x ที่ระบบรับเสียงเสถียร
- ปรับเฉพาะระดับการสุก
- แสดงผลหลัก 3 ช่วง: สุกเกิน / สุกพอดี / ใกล้สุกหรือยังไม่พร้อม
- ถ้า f_mean > 650 Hz แสดงคำเตือนเพิ่ม: มีแนวโน้มยังดิบมาก
- ถ้า A/B และมี hollow/firmness/low_ratio เสี่ยง แสดงคำเตือนสุกเกินหรือโพรง
- ไม่แตะ Brix / Firmness / Juice / Hollow
- ไม่แตะระบบรับเสียง / FFT / tap detection / Export
- ลบเฉพาะโค้ด v25 ที่ไม่เกี่ยวข้อง ถ้ามีหลงเหลือ

## v24.9 Hollow Overripe Clean UI
- ปรับเฉพาะระดับการสุก
- สุกเกินต้องมี f_mean ต่ำร่วมกับหลักฐานโพรง/เนื้อนิ่ม/low_ratio สูง
- แสดงผลหลัก 3 ช่วง: สุกเกิน / สุกพอดี / ใกล้สุกหรือยังไม่พร้อม
- ถ้า f_mean > 650 Hz แสดงคำเตือน: มีแนวโน้มยังดิบมาก
- ตัดข้อความ “AI Voice Summary อ่านสรุปผลแบบภาษาคน ไม่อ่านตัวเลข”
- ตัดข้อความ “วิเคราะห์เสียงช่วง 50-1000Hz”
- ไม่แตะ Brix / Firmness / Juice / Hollow
- ไม่แตะระบบรับเสียง / FFT / tap detection / Export
